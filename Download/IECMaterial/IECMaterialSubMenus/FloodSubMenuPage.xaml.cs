...
namespace ResillentConstruction.IECMaterial.IECMaterialSubMenus
{
    ...
    public partial class FloodSubMenuPage : ContentPage
    {
        public Label[] Footer_Labels;
        public string[] Footer_Image_Source;
        public Image[] Footer_Images;
        public FloodSubMenuPage(string menuname)
        {
            InitializeComponent();
            ...
            Btn_FloodSafety.Text = App.LableText("FloodSafety");

        
        }
        private void Btn_FloodSafety_Clicked(object sender, EventArgs e)
        {
            Launcher.OpenAsync(new Uri("https://hpsdma.nic.in/WriteReadData/LINKS/showimg%20(10)d9f26152-ec5f-4b45-ab80-85be94421ab6.pdf"));
        }
