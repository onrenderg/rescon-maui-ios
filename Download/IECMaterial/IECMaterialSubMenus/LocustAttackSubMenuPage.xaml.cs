...
namespace ResillentConstruction.IECMaterial.IECMaterialSubMenus
{
    ...
    public partial class LocustAttackSubMenuPage : ContentPage
    {
        public Label[] Footer_Labels;
        public string[] Footer_Image_Source;
        public Image[] Footer_Images;
        public LocustAttackSubMenuPage(string menuname)
        {
            InitializeComponent();
            ...
            Btn_Leaflet.Text = App.LableText("Leaflet");
            Btn_GeneralInstructionHindi.Text = App.LableText("GeneralInstructionHindi");
        }

        private void Btn_Leaflet_Clicked(object sender, EventArgs e)
        {
            Launcher.OpenAsync(new Uri("https://hpsdma.nic.in//admnis/admin/showimg.aspx?ID=3329"));
        }

        private void Btn_GeneralInstructionHindi_Clicked(object sender, EventArgs e)
        {
            Launcher.OpenAsync(new Uri("https://hpsdma.nic.in//admnis/admin/showimg.aspx?ID=3330"));
        }
