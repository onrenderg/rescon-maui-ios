...
namespace ResillentConstruction.IECMaterial.IECMaterialSubMenus.AwarenessMaterialSubSubMenu
{
    ...
    public partial class AwarenessMaterialUrbanRiskReductionPage : ContentPage
    {
        public Label[] Footer_Labels;
        public string[] Footer_Image_Source;
        public Image[] Footer_Images;
        public AwarenessMaterialUrbanRiskReductionPage(string menuname)
        {
            InitializeComponent();
            ...
            Btn_ShimlaURRhandbillonFire.Text = App.LableText("ShimlaURRhandbillonFire");
            Btn_ShimlaURRExhibition.Text = App.LableText("ShimlaURRExhibition");
          

        }
        private void Btn_ShimlaURRhandbillonFire_Clicked(object sender, EventArgs e)
        {
            Launcher.OpenAsync(new Uri("https://hpsdma.nic.in/WriteReadData/LINKS/showimg%20(17)da7ce067-d883-4942-8bad-0babffb0e68e.pdf"));
        }

        private void Btn_ShimlaURRExhibition_Clicked(object sender, EventArgs e)
        {
            Launcher.OpenAsync(new Uri("https://hpsdma.nic.in/WriteReadData/LINKS/showimg%20(15)9820d9cf-c553-497e-b331-47b5ce99316a.pdf"));
        }
